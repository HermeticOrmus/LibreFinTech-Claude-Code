...
A comprehensive pattern library and knowledge base for open-banking.

## Knowledge Base

### Core Concepts
- **Fundamentals**: The foundational principles that govern open-banking
...
- **Tools**: Common tools and frameworks used for open-banking

### Architecture Principles
- Separation of concerns within open-banking implementations
...
### Tools
- Development tools for open-banking
